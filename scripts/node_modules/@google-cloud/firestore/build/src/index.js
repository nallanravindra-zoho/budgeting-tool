...
const firestore_api_1 = require("@google-cloud/firestore-api");
Object.defineProperty(exports, "protos", { enumerable: true, get: function () { return firestore_api_1.protos; } });
...
const firestore_client_config_json_1 = require("@google-cloud/firestore-api/build/src/v1/firestore_client_config.json");
    ...
    get: () => {
        if (!cachedV1beta1) {
            ...
            const fn = function (...args) {
                return new api.FirestoreClient(...args);
            };
